...
// Design Confirmation attaches the uploaded Sticker/Box/Frosted Ziplock/Butter Paper design
// PDF the same way.
const DOCUMENT_ONLY_TEMPLATE_EVENT_KEYS = ['billing-invoice', 'bulk-purchase-request', 'purchase-ask-quotation', 'design-confirmation'];
