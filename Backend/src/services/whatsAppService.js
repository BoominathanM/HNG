...
const DEFAULT_EVENTS = [
  ...
  { key: 'design-confirmation', label: 'Design Confirmation', description: 'Sent to the sales person and the customer when a packaging design (Sticker/Box/Frosted Ziplock/Butter Paper) is sent for approval, with the design PDF attached', availableFields: ['orderCode', 'customerName', 'salesPersonName', 'productName', 'packagingType', 'companyName'] },
  ...
  { key: 'purchase-ask-quotation', label: 'Purchase - Ask Quotation (Per Item)', description: 'Sent to the vendor with a Product/Required-Quantity document when "Ask Quotation" is clicked in Purchase → Quotation & Raise Request table (per-item request)', availableFields: ['vendorName', 'itemName', 'itemCount', 'totalQty', 'companyName'] },
  ...
  { key: 'separate-purchase-payment-reminder', label: 'Separate Purchase Payment Reminder', description: 'Sent to the configured Financial-department recipients when an individually-raised (non-bulk) purchase request\'s payment reminder date arrives', availableFields: ['requestCode', 'itemName', 'qty', 'vendorName', 'dueDate', 'companyName'] },
];
